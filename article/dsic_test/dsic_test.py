...
================================================================================
  ...
  ⏳  ПОЖАЛУЙСТА, НАБЕРИТЕСЬ ТЕРПЕНИЯ.
      ...
      Полный прогон занимает ориентировочно 15–25 минут и складывается из:
        ...
        • блока [11] «рост структур» — самого долгого этапа: это скан по сетке
          с численным интегрированием ОДУ роста в каждом узле (~15 минут).
